...
@section('content')
    ...
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-md-5">
                <img src="{{ asset('front_assets/img/mapsana-imgs/herobanerimg.webp') }}" width="570px" height="450px"
                    alt="herosection-image" style="border-radius: 0 45% 45% 0" srcset="" />
            </div>
            <div class="col-md-7">
        ...
        <div class="container">
            <form class="banner-form">
                <div class="row ban-col py-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control inputtag placholder pl1"
                            placeholder="Insert your address to find health professional next to you" />
                    </div>
        ...
        <div class="row services">
            ...
            <div class="col-md-5 .scale-up-center">
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-house-chimney-medical sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                        <a href="#">Atención a domicilio</a>
                    </div>
                    <div>
                        <i class="fa-solid fa-angle-right rigth-arow"></i>
                    </div>
                </div>
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-hands-holding-child sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                        <a href="#">Pediatría</a>
                    </div>
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-user-injured sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-brain sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-user-nurse sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                        <a href="#">Enfermeria</a>
                    </div>
            ...
            <div class="col-md-5 .scale-up-center">
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-child-reaching sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-person-pregnant sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-children sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-map-location-dot sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                ...
                <div class="service-container">
                    <div class="icon-div">
                        <i class="fa-solid fa-user-doctor sr-icon"></i>
                    </div>
                    <div class="service-icon-link">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="d-flex flex-row">
                                    <ul class="nav nav-tabs nav-justified vertical-tab flex-column" id="myTab"
                                        role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="tab-one" data-toggle="tab" href="#tab1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="tab-two" data-toggle="tab" href="#tab2"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="tab-three" data-toggle="tab" href="#tab3"
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                            ...
                                            <div class="text-overlayy">
                                                <div class="aboutContent">
                                                    <img src="{{ asset('front_assets/service-imgs/Doctor2.png') }}"
                                                        alt="" />
                                                    <div class="textClass">
                                                        <h1>About Us</h1>
                                                        <p>
                                        ...
                                        <div class="tab-pane fade" id="tab2" role="tabpanel"
                                            ...
                                            <div class="text-overlayy">
                                                <div class="aboutContent">
                                                    <img src="{{ asset('front_assets/img/howitworks.png') }}"
                                                        alt="" />
                                                    <div class="textClass">
                                                        <h1>How It Works</h1>
                                                        <p>
                                        ...
                                        <div class="tab-pane fade" id="tab3" role="tabpanel"
                                            ...
                                            <div class="text-overlayy">
                                                <div class="aboutContent">
                                                    <img src="{{ asset('front_assets/img/ourmission.png') }}"
                                                        alt="" />
                                                    <div class="textClass">
                                                        <h1>Our Mission</h1>
                                                        <p>
                        ...
                        <div class="card shadow-sm bg-light">
                            <div class="card-body">
                                ...
                                <div class="img d-flex justify-content-center">
                                    <img src="{{ asset('front_assets/doctor-imgs/doc2.png') }}" width="100"
                                        height="100" class="card-img" alt="" />
                                </div>
                                <div>
