...
@section('script')
    ...
    <script>
        ...
        $("#datatable-default").on("click", "button#approveDoctor", function() {
            ...
            swal({
                ...
                function(willDelete) {
                    if (willDelete) {
                        // var token = $("meta[name='csrf-token']").attr("content");
                        var url = '{{ url('/admin/user/approve') }}' + '/' + id;
                        $.ajax({
                            url: url,
                            type: 'GET',
                            // data: {
        ...
        $("#datatable-default").on("click", "button#blockDoctor", function() {
            ...
            let text = status ? 'You want to block this user' : 'You want to active this user';
            
            swal({
                    title: 'Are you sure?',
                    text: textmsg, type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: "btn-primary",
                    confirmButtonText: "Yes!",
                    closeOnConfirm: false
                ...
                function(willDelete) {
                    if (willDelete) {
                        // var token = $("meta[name='csrf-token']").attr("content");
                        var url = '{{ url('/admin/user/block') }}' + '/' + id + '/' + status;
                        $.ajax({
                            url: url,
                            type: 'GET',
                            // data: {
