            ...
            <div class="">
                    ...
                    <form action="{{ route('doctor.login') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class=""
                                placeholder="johnsmith@gmail.com" value="{{ old('email') }}" required />
                            @error('email')
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="passwordsignin" class="" placeholder="XXXXXXXX"
                                required />
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group">
                            ...
                            <a class="ml-3" href="{{ route('doctor.password.request') }}">Forgot password</a>
                        </div>
                ...
                <div class="mt-3">
                    <p class="signintext">
                        ...
                        <a href="{{ route('doctor.register') }}">Register now</a>
                    </p>
                </div>
            </div>
        </div>
