            ...
            <div class="row container-fluid wow fadeInUp">
                <div class="col-md-6 form_imgdiv bg-light left_part">
                    <div id="gmap">
                        <div class="">
                            <div class="d-flex">
                                <img src="{{ asset('front_assets/img/Mapsana Logo.png') }}" alt="mapsana" height="60px" class="mb-5" srcset="">
                            </div>
                        ...
                        <img src="{{ asset('front_assets/img/Doctors-pana.png') }}" class="" width="500px" alt="doctor-img">
                    </div>
                    <div class="otpAnim" id="otpanimation">
                        <img src="{{ asset('front_assets/gif_animations/enterotp.gif') }}" height="480" alt="submit otp picture" srcset="">
                    </div>
                </div>
                <div class="col-md-6 form_div">
                    ...
                    <form class="signup-form" id="signup-form">
                        ...
                        <div class="form-row mb-3 input-group">
                            <div class="col-6 pr-2">
                                ...
                                <input type="text" name="firstname" placeholder="John" class="form-control" required id="firstname" />
                            </div>
                            <div class="col-6 p-0">
                                <label for="lastname">Last Name</label>
                                <input type="text" name="lastname" placeholder="Smith" class="form-control" required id="lastname" />
                            </div>
                        </div>
                        <div class="form-group mb-3 pr-1">
                            <label for="email">Email Address</label>
                            <input type="email" name="email" class="form-control" id="email" placeholder="john@gmail.com" />
                            <span id="emailspan"></span>
                        </div>
                        <div class="form-row input-group mt-3">
                            <div class="col-6 pr-2">
                                <label for="n-id">National ID</label>
                                <input type="number" class="form-control" required id="n-id" autocomplete="off" name="nid" placeholder="XXXXX-XXXXXXXX-X" />
                                <span id="nidspan"></span>
                            </div>
                            <div class="col-6 p-0">
                                <label for="no-reg">Registration Number</label>
                                <input type="number" class="form-control" required id="no-reg" name="reg_no" placeholder="XXXXXX" />
                                <span id="no-regspan"></span>
                            </div>
                        </div>
                        <div class="form-group mt-3 pr-1">
                            <label for="dob">Date of Birth</label>
                            <input type="date" class="form-control" required onfocus="this.showPicker();" name="dob" id="dob" />
                        </div>
                        <div class="form-group mt-3 pr-1">
                            <label for="password">Password</label>
                            <input type="password" class="form-control" placeholder="********" id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.*\s).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required />
                        </div>
                        <div class="p-2 pb-0">
                        ...
                        <div class="form-group mt-3 p-1">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="approval" id="approval" required />
                    ...
                    <div class="otp-container p-4" id="otpbox" style="display: none">
                        <div class="d-flex justify-content-center">
                            <img src="{{ asset('front_assets/img/pinimage.png') }}" width="80" height="80" alt="" />
                        </div>
                        ...
                        <div class="otp-form d-flex flex-column align-items-center justify-content-center mt-3">
                            <form action="" id="otp">
                                @csrf
                                <input type="hidden" name="otpemail" class="form-control" id="otpemail" placeholder="" />
                                <input type="number" name="otpnumber[]" min="0" max="9" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" id="numberOne" form-control rounded autofocus />
                                <input type="number" name="otpnumber[]" min="0" max="9" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" id="numberOne" form-control rounded autofocus />
                                <input type="number" name="otpnumber[]" min="0" max="9" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" id="numberOne" form-control rounded autofocus />
                                <input type="number" name="otpnumber[]" min="0" max="9" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==1) return false;" id="numberOne" form-control rounded autofocus />
                                <div class="twobtn">
